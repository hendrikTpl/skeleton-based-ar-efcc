...
# @Last modified time: 2020-03-08T22:52:05+08:00
...
class REC_Processor(Processor):
    ...
    def test(self, evaluation=False):
        ...
        if self.result.shape[0] != 0:
            ...
            data = int(np.argmax(self.result[0, :],0))
        id_process = self.arg.id_process
        index_data = self.arg.index_data
        output_send= id_process + '_' + index_data +'.json'
        with open(output_send, 'w') as outfile:
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('--id_process', type=str)
