...
# @Date:   2020-03-08T23:38:11+08:00
# @Email:  aji.setyoko.second@gmail.com
# @Last modified by:   simslab-cs
# @Last modified time: 2020-03-08T23:40:51+08:00
...
class Processor(IO):
    ...
    def load_data(self):
        Feeder = import_class('feeder.feeder.Feeder')
    ...
    def get_parser(add_help=False):
        ...
        # feeder
        parser.add_argument('--feeder', help='data loader will be used')
        ...
        parser.add_argument('--weights', default=[], help='the weights for network initialization')
