...
function detectPoseInRealTime(video, net) {
	...
	async function poseDetectionFrame() {
		...
		//fs annd path to saved JSON
		const fs = require('fs');
		const path = require('/home/infinity/github/tfjs-models/posenet/demos/save_json');
		...
		switch (guiState.algorithm) {
			case 'single-pose':
				...
				//save file json
				fs.writeFileSync(path.resolve(__dirname, 'poses_data.json'), JSON.stringify(poses));
